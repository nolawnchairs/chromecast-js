...
var Media_1 = (0, tslib_1.__importDefault)(require("./Media"));
var MediaQueue_1 = (0, tslib_1.__importDefault)(require("./MediaQueue"));
...
var ChromecastInstance = (function () {
    ...
    ChromecastInstance.prototype.setResumeStateListener = function (listener) {
    ...
    ChromecastInstance.prototype.onAnyEvent = function (listener) {
        this._eventDelegate.setAnyEventListener(listener);
    };
    ChromecastInstance.prototype.unregisterAll = function () {
    ...
    ChromecastInstance.prototype.removeFromQueue = function (item) {
        ...
        if (item >= this._queue.length)
            throw new Error("Chromecast::removeFromQueue - Index out of bounds, attempt to reference index ".concat(item, " of ").concat(this._queue.length, " items"));
    ...
    ChromecastInstance.prototype.reorderQueue = function (from, to) {
        ...
        if (from >= this._queue.length - 1)
            throw new Error("Chromecast::reorderQueue - Index out of bounds, attempt to reference index ".concat(from, " of ").concat(this._queue.length, " items"));
    ...
    ChromecastInstance.prototype.getCastDeviceName = function () {
