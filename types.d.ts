...
export declare class Chromecast {
  constructor();
  /**
   * Whether or not the chromecase service has been
...
export declare namespace chrome.cast.media {
...
*/
export declare namespace chrome.cast.media.timeout {
